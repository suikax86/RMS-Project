-- Script drop
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS WHERE CONSTRAINT_TYPE = 'FOREIGN KEY' AND TABLE_NAME = 'Accounts')
    BEGIN
        ALTER TABLE Accounts DROP CONSTRAINT IF EXISTS FK_Accounts_Roles;
    END
GO;

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS WHERE CONSTRAINT_TYPE = 'FOREIGN KEY' AND TABLE_NAME = 'Companies')
    BEGIN
        ALTER TABLE Companies DROP CONSTRAINT IF EXISTS FK_Companies_Accounts;
    END
GO;

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS WHERE CONSTRAINT_TYPE = 'FOREIGN KEY' AND TABLE_NAME = 'Applicant')
    BEGIN
